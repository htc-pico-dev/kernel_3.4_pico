...
void __init pico_reset_mmu(void) {
	uint32_t j;
...
static struct mdp_reg pico_color_enhancement[] = {
...
static int pico_mdp_color_enhancement(void)
{
	PR_DISP_INFO("%s\n",__func__);
...
2.error handling
 */
static int __init pico_init_panel(void)
{
	int ret=0;
